  ...
  return (
    ...
    >
      <PopoverTrigger
        ...
        style={{
          backgroundColor: internalValue.hex,
          backgroundImage:
            internalValue.a === 255
              ? undefined
      ...
      <PopoverContent side="bottom" {...props}>
        <div className="p-2">
          <RgbaColorPicker
            ...
            onChange={({ r, g, b, a }) =>
              setInternalValue((prevInternalValue) =>
                prevInternalValue.set(
                  [r, g, b, round(map(a, 0, 1, 0, 255))],
                  true
                )
              )
            }
          ...
          <div className="flex justify-between">
            <span>{internalValue.hex}</span>
            <span
              className="h-4 w-4"
              style={{ backgroundColor: internalValue.hex }}
            />
          </div>
        </div>
      </PopoverContent>
